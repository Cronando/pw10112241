    ...
    <div class="card">
      ...
      <div class="card-body">
        <Form :validation-schema="validationSchema" @submit="onTodoBien">
                    <div class="md-3">
                        ID 
                        <Field name="idvendedor" id="idvendedor" class="form-control" type="number" v-model="model.vendedores.idvendedor" />
                        <ErrorMessage name="idvendedor" class="errorValidation"/>
                    </div>
                    <div class="md-3">
                        Nombre 
                        <Field name="nombre" id="nombre" class="form-control" type="text" v-model="model.vendedores.nombre" />
                        <ErrorMessage name="nombre" class="errorValidation"/>
                    </div>
                    <div class="md-3">
                        Apellidos 
                        <Field name="apellido" id="apellido" class="form-control" type="text" v-model="model.vendedores.apellido" />
                        <ErrorMessage name="apellido" class="errorValidation"/>
                    </div>
                    <div class="md-3">
                        departamentotienda 
                        <Field name="departamentotienda" id="departamentotienda" class="form-control" type="text" v-model="model.vendedores.departamentotienda" />
